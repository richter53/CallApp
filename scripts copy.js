...
document.querySelector('#volume-slider').addEventListener('input', e => {
    const volume = e.target.value; // Get the current slider value (0.0 to 1.0)
    remoteVideoEl.volume = volume; // Set the volume on the video element
...
// Event Listeners
document.querySelector('#mute-audio').addEventListener('click', muteAudio);
document.querySelector('#unmute-audio').addEventListener('click', unmuteAudio);
